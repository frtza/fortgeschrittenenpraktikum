...
\end{equation}
geschlossen werden.
Für die Lande Faktoren der Isotope ergeben sich die Werte
\begin{align}
    g_1 &= \qty{0.487(4)} \\
    q_2 &= \qty{0.3278(0.5)} .
\end{align}
Anhand der in Abschnitt \ref{sec:theorie} bestimmten Werte für die Lande Faktoren der Isotope können schließlich
