...
im einen äußeren Elektron tragen \cite{rubidium}. Daher kann in diesem Fall immer $S = \frac{1}{2}$ eingesetzt werden.
...
ersetzt. Entlang der Feldrichtung präzidiert nun $\bm{\mu}_J$ und führt über die Richtungsquantelung die Wechselwirkungsenergie
\begin{equation}
	E_Z = M_J g_J \mu_B B
	\label{eqn:lin_zeeman} 
\end{equation}
