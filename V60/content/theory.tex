...
\begin{figure}[H]
    ...
    \caption{Schematic of the differen constributions to the net gain.\cite{diode_laser}} %\cite
    \label{fig:netgain}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Internal cavity, grating feedback and external cavity modes.\cite{diode_laser}} %\cite
    \label{fig:best} 
\end{figure}

As the temperature rises, the maximum gain of the medium and the internal cavity shift to longer wavelengths with different rates.
This creates mode hops.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{content/graphics/modehops.jpg}
    \caption{Rubidium Absorption Spectrum.\cite{diode_laser}} %\cite
    \label{fig:mode} 
\end{figure}
